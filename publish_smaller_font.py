...
def main():
    ...
    # 新上传的封面图片 media_id
    thumb_media_id = "VzuvmlZBA-BK84Y6UaFkv88fjs6qfW1cF4NaeuecQlNZdbLra4M0QLvtUTneBMit"

    print("=" * 60)
    print("  微信公众号字体稍小创意排版发布")
    print("=" * 60)
    print(f"标题: {title}")
    print(f"作者: {author}")
    ...
    try:
        ...
        print("字体稍小创意排版特点:")
        print("  ✅ 渐变色标题（红橙→金色，28px稍小）")
        print("  ✅ 卡片式布局（圆角+阴影）")
        print("  ✅ 彩色左边框（每段不同色）")
        print("  ✅ 段落字体14px（原15px）")
        print("  ✅ 标题字体28px（原32px）")
        print("  ✅ 统一段落间距")
        print("  ✅ 重点字彩色高亮")
        print("  ✅ 结尾精美卡片\n")
